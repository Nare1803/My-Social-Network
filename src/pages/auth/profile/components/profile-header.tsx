        ...
        <div className="min-h-screen bg-gray-900 text-white flex flex-col items-start p-6">
            <div className="flex items-center gap-6 mb-6">
                ...
                <div>
                    ...
                    {/* <p className="text-gray-400 text-sm mt-2">
                        {isPrivate ? "This is a private profile." : "This is a public profile."}
                    </p> */}
                </div>
                <input
                    type="file"
            ...
            <div className="flex gap-8">
                <div className="flex flex-col">
                    <p className="text-sm font-bold text-blue-400">{user.followers.length || 0}</p>
                    <p className="text-gray-400 text-sm">Followers</p>
                </div>
                <div className="flex flex-col">
                    <p className="text-sm font-bold text-blue-400">{user.following.length || 0}</p>
                    <p className="text-gray-400 text-sm">Following</p>
                </div>
                <div className="flex flex-col">
                    <p className="text-sm font-bold text-blue-400">{user?.posts?.length || 0}</p>
